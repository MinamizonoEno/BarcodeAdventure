...
import cordchan_clear from '../../../assets/image/cordchan/cordchan_clear.png';
...
export const WinModal0103: FC<Props> = ({ openWinModal }) => {
    ...
    >
      <Box sx={{ height: '100%', width: '100%', bgcolor: '#C6ABAB', position: 'relative' }}>
        ...
        >
          ...
          >
            <Typography sx={{ fontSize: '1.3rem' }}>メニューへ</Typography>
          </Button>
        </Box>
      </Box>
    </Modal>
